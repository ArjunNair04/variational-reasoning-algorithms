...
#$ -l tmem=24G
#$ -t 1-70
#$ -cwd -j y -o logs/qwen3_final_method_confirmation.$JOB_ID.$TASK_ID.log
...
export YAML=${YAML:-$PROJ/lm_study/experiments_qwen3_17b_final_method_confirmation.yaml}
...
echo "== final method confirmation | cell $((cell_index + 1))/$cell_count | seed $((seed_index + 1))/$seed_count | $(hostname) | $(date) =="
