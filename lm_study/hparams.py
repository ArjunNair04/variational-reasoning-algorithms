...
KNOBS = (
    ...
    Knob("responsibility_prior_head_exponent", float, "rphe",
         "Q5 positional E-step exponent on the first floor(n/2) rationale tokens"),
    Knob("responsibility_prior_tail_exponent", float, "rpte",
         "Q5 positional E-step exponent on the remaining rationale tokens"),
