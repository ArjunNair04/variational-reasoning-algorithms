...
#$ -l tmem=24G
#$ -t 1-14
#$ -cwd -j y -o logs/qwen3_q5_buffer_sampling.$JOB_ID.$TASK_ID.log
...
export YAML=${YAML:-$PROJ/lm_study/experiments_qwen3_17b_q5_buffer_sampling.yaml}
...
echo "== Q5 buffer sampling | cell $((cell_index + 1))/$cell_count | seed $((seed_index + 1))/$seed_count | $(hostname) | $(date) =="
