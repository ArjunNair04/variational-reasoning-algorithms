...
RESULT_OUT=${RESULT_OUT:-$HOME/po_results/2026-09-14/q5-prior-segments/qwen3-q5-prior-segments__a2f46c91}
MARKER=${MARKER:-$HOME/po_results/auto_state/qwen3_q5_prior_segments_a2f46c91.ok}
CONTROL_MARKER=${CONTROL_MARKER:-$HOME/po_results/auto_state/qwen3_selected_method_posterity_68078ecc.ok}
CLAIM_DIR=${CLAIM_DIR:-$HOME/po_results/auto_state/qwen3_q5_prior_segments_20260914.submit.claim}
...
"$VENV/bin/python" "$PROJ/analysis/audit_q5_prior_segments_pretraining.py" \
  --check-training-gate "$PROJ/docs/experiments/qwen3_q5_prior_segments/pretraining_audit/audit_manifest.json"
